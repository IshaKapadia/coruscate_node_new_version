...
/**
 * @description : getMeetingBySpace 
 * @param {Object} req : request
 * @param {Object} res : response 
 * @return {Object} : response of getMeetingBySpace {status, message, data}
 */
const getMeetingBySpace = async (req,res)=>{
  let result = await Meeting.findOne(req,{ space_id }); 
